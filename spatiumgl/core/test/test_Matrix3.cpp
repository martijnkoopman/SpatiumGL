...
{
	const spatiumgl::Matrix3 matrix1 = { {4,8,12}, {16,20,24}, {28,32,36} };
	const spatiumgl::Matrix3 matrix2 = { {1,2,3}, {4,5,6}, {7,8,9} };
	const spatiumgl::Matrix3 result = matrix1 + matrix2;
	const spatiumgl::Matrix3 correct = { {5,10,15}, {20,25,30}, {35,40,45} };
	EXPECT_EQ(correct, result);
}
...
TEST(Matrix3, subtractMatrix)
{
	...
	const spatiumgl::Matrix3 matrix2 = { {1,2,3}, {4,5,6}, {7,8,9} };
	const spatiumgl::Matrix3 result = matrix1 - matrix2;
	const spatiumgl::Matrix3 correct = { {3,6,9}, {12,15,18}, {21,24,27} };
	EXPECT_EQ(correct, result);
}
...
TEST(Matrix3, multiplyScalar)
{
	...
	const spatiumgl::Matrix3 correct = { {2,4,6}, {8,10,12}, {14,16,18} };
	EXPECT_EQ(correct, result);
};
...
{
	const spatiumgl::Matrix3 matrix = { {2,4,6}, {8,10,12}, {14,16,18} };
	const spatiumgl::Matrix3 result = matrix / 2;
...
TEST(Matrix3, inverse)
{
	...
	const spatiumgl::Matrix3 correct = { {0.2, -0.2, 0.2}, {0.2, 0.3, -0.3}, {0, 1, 0} };
	EXPECT_EQ(correct, result);
}
