...
struct SPATIUMGL_EXPORT Matrix<T, 3, 3> : public MatrixBase<T, 3, 3>
{
  ...
  Vector<T, 3> operator*(const Vector<T, 3>& vector) const
  {
    ...
    result[0] = this->m_data[0][0] * vector[0] +
                this->m_data[1][0] * vector[1] + this->m_data[2][0] * vector[2];
    result[1] = this->m_data[0][1] * vector[0] +
                this->m_data[1][1] * vector[1] + this->m_data[2][1] * vector[2];
    result[2] = this->m_data[0][2] * vector[0] +
                this->m_data[1][2] * vector[1] + this->m_data[2][2] * vector[2];
    return result;
  }
  ...
  constexpr T determinant() const
  {
    return this->m_data[0][0] * (this->m_data[1][1] * this->m_data[2][2] -
                                 this->m_data[2][1] * this->m_data[1][2]) -
           this->m_data[1][0] * (this->m_data[0][1] * this->m_data[2][2] -
                                 this->m_data[2][1] * this->m_data[0][2]) +
           this->m_data[2][0] * (this->m_data[0][1] * this->m_data[1][2] -
                                 this->m_data[1][1] * this->m_data[0][2]);
  }
