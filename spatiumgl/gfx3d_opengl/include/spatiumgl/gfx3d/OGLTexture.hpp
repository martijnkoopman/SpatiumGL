...
#ifndef SPATIUMGL_GFX3D_TEXTURE_H
#define SPATIUMGL_GFX3D_TEXTURE_H
...
public:
  ...
  /// \param[in] generateMipmap Generate mipmap (default = false)
      ...
      {
        int byteCount = channelSize(m_pixelType) * channelCount(m_pixelFormat) *
                        m_width * m_height;
      ...
      void bind() const override { glBindTexture(GL_TEXTURE_2D, m_textureId); }
